...
class Transaction extends CI_Controller {
    ...
    function searchtransaction() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            $this->load->view('adminlogin/transaction/searchtransaction', $data);
    ...
    function studentacademicreport() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            $this->load->view('adminlogin/layout/header', $data);
            $this->load->view('adminlogin/transaction/studentAcademicReport', $data);
            $this->load->view('adminlogin/layout/footer', $data);
        } else {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (!empty($studentlist)) {
                    foreach ($studentlist as $key => $eachstudent) {
                        ...
                        $obj->section = $eachstudent['division'];
