...
class Feediscount extends CI_Controller {
    ...
    function index() {
        ...
        $this->form_validation->set_rules('code', 'Discount Code', 'trim|required');
        $this->form_validation->set_rules('name', 'Name', 'trim|required');
        $this->form_validation->set_rules('amount', 'Amount', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('adminlogin/layout/header', $data);
            $this->load->view('adminlogin/feediscount/feediscountList', $data);
    ...
    function assign($id) {
        ...
        $this->load->view('adminlogin/layout/header', $data);
        $this->load->view('adminlogin/feediscount/assign', $data);
        $this->load->view('adminlogin/layout/footer', $data);
    }
