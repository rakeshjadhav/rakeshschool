...
class Homework extends CI_Controller {
    ...
    public function index() {
       ...
       // var_dump($_POST);exit;
        ...
        $this->load->view("adminlogin/homework/homeworklist", $data);
        $this->load->view("adminlogin/layout/footer", $data);
       // $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Home Work add successfully</div>');
    }
    ...
    public function create() {
        ...
        $this->form_validation->set_rules('homework_date', 'Homework Date', 'trim|required');
    ...
    public function evaluation($id) {
        ...
        $this->load->view("adminlogin/homework/evaluation_modal", $data);
    }
    
    public function download($id, $doc) {
        $this->load->helper('download');
        $filepath = "./uploads/homework/" . $id . "." . $this->uri->segment(7);
    ...
    public function evaluation_report() {
        ...
        $this->load->view("adminlogin/homework/homework_evaluation", $data);
