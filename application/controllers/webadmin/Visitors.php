...
class Visitors extends CI_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('adminlogin/frontoffice/visitorview', $data);
    ...
    public function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('adminlogin/layout/header');
            $this->load->view('adminlogin/frontoffice/visitoreditview', $data);
            $this->load->view('adminlogin/layout/footer');
        } else {
            // print_r($_FILES);
            //exit;
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success"> Visitors Update successfully</div>');
            redirect('webadmin/visitors');
        }
    }
    ...
    public function details($id) {
        ...
        $this->load->view('adminlogin/frontoffice/visitormodelview', $data);
    }
