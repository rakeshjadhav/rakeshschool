...
class Complainttype extends CI_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('adminlogin/frontoffice/complainttypeview', $data);
            ...
            redirect('webadmin/complainttype');
        }
    }
    ...
    function editcomplainttype($complainttype_id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('adminlogin/layout/header');
            $this->load->view('adminlogin/frontoffice/complainttypeeditview', $data);
            $this->load->view('adminlogin/layout/footer');
        } else {
