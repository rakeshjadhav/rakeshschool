                        ...
                        <div class="">
                            <div class="panel " >
                                <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> 
                                   <i class="fa fa-database fa-fw"></i> || Update Academic Years
                               </div>
                                  <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="<?php echo site_url("webadmin/sessions/edit/". $id) ?>" method="post">
                                         <?php if ($this->session->flashdata('msg')) { ?>
                                         <?php echo $this->session->flashdata('msg') ?>
                                         <?php } ?>   
                                         <?php //echo $this->customlib->getCSRF(); ?>
                                        <div class="form-group">
                                         <label for="">Academic Year</label><small class="req"> *</small>
                                        ...
                                        <input type="submit" name="" id=""class="btn btn-sm btn-success waves-effect waves-light m-r-10" value="Update" style="font-style: normal; " data-toggle="modal" data-target=".bs-example-modal-sm" >
                            ...
                            <div class="table-responsive">
                                 <table id="example23" class="display nowrap" >
                                    ...
                                    foreach ($sessionlist as $session) {
                                        ?>
                                        <tr>
                                            <td class=""><?php echo $session['session'] ?></td>
                                            <td class=""><?php
                                                if ($session['active'] != 0) {?>
