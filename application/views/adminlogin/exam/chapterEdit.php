            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">
                               <i class="fa fa-home fa-fw"></i> || Update Subject wise Chapter
                        </h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                             <li class="active">Update Subject Wise Chapter</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="">
                            <div class="panel " >
                                <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> 
                                    <i class="fa fa-retweet"></i> ||  Update Subject Wise Chapter
                               </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <form action="<?php echo site_url("webadmin/exam/chapteredit/" . $id) ?>" method="post">
                                        <div class="form-group">
                                                    <label>Class Name</label>
                                                      <div class="input-group">
                                                       <div class="input-group-addon"><i class="fa fa-university"></i></div>
                                                        <select autofocus="" id="class_id" name="class_id" class="form-control" >
                                                            <option value="<?php echo $chapterwisedata['class_id'] ?>"><?php echo $chapterwisedata['class'] ?></option>
                                                            <?php
                                        ...
                                        <div class="form-group">
                                                ...
                                                <select  id="section_id" name="section_id" class="form-control"  >
                                                        <option value="<?php echo $chapterwisedata['division_id'] ?>"><?php echo $chapterwisedata['division'] ?></option>
                                                </select>
                                                 </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <select  id="subject_id" name="subject_id" class="form-control" >
                                                          <option value="<?php echo $chapterwisedata['subject_id'] ?>"><?php echo $chapterwisedata['subjectname'] ?></option>
                                                </select>
                                                 </div>
                                        ...
                                        <div class="form-group">
                                            <label for="">Chapter Name</label>
                                              <div class="input-group">
                                                 <div class="input-group-addon"><i class="fa fa-retweet"></i></div>
                                                 <input  class="form-control" id="chapter_name" name="chapter_name" placeholder="" rows="3" placeholder="Enter Chapter" value="<?php echo set_value('chapter_name',$chapterwisedata['chapter_name']); ?>">
                                    <span class="text-danger"><?php echo form_error('chapter_name'); ?></span>
                                        ...
                                        <div class="form-group">
                                            <label for="">description</label>
                                              <div class="input-group">
                                                 <div class="input-group-addon"><i class="fa fa-retweet"></i></div>
                                                 <textarea class="form-control" id="desc" name="desc" placeholder="" rows="3" placeholder="Enter ..."><?php echo set_value('desc',$chapterwisedata['cdesc']); ?></textarea>
