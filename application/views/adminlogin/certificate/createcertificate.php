                              ...
                              <div class="">
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12 col-xs-12">
                                          ...
                                          <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('webadmin/certificate/create') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="mediarow">    
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 img_div_modal">
                                            <div class="form-group">
                                                <input id="header_height" name="header_height" placeholder="header height" type="text" class="form-control" min="0" />
                                            </div>
                                        </div><!--./col-md-6-->   
                                        <div class="col-md-6 col-sm-6 img_div_modal"> 
                                            <div class="form-group">
                                                <input id="footer_height" name="footer_height" placeholder="footer height" type="text" class="form-control" min="0" />
                                            </div>
                                        </div><!--./col-md-6-->
                                        <div class="col-md-6 col-sm-6 img_div_modal">
                                            <div class="form-group">
                                                <input id="content_height" name="content_height" placeholder="body height" type="text" class="form-control" min="0" />
                                            </div>
                                        </div><!--./col-md-6-->
                                        ...
                                        <div class="col-md-6 col-sm-6 img_div_modal"> 
                                            <div class="form-group">
                                                <input id="content_width" name="content_width" placeholder="body width" type="text" class="form-control" min="0" />
                                            </div>
                                        </div><!--./col-md-6-->
                                        ...
                                        <div class="col-md-6 col-sm-6 img_div_modal">
                                            <div class="form-group" id="enableImageDiv" hidden>
                                                <input id="image_height" name="image_height" placeholder="photo height" type="text" class="form-control" min="0" />
                                            </div>
                                        </div>
                                        ...
                                        foreach ($certificateList as $certificate) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date text-right no-print">
                                                    <a id="<?php echo $certificate->id ?>" class="btn btn-info btn-xs view_data" title="view" data-toggle="tooltip">
                                                        <i class="fa fa-reorder"></i>
                                                    </a>
                                                    <?php
                                                   // if ($this->rbac->hasPrivilege('student_certificate', 'can_edit')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>webadmin/certificate/edit/<?php echo $certificate->id ?>" class="btn btn-primary btn-xs"  data-toggle="tooltip" title="edit">
                                                   ...
                                                   // if ($this->rbac->hasPrivilege('student_certificate', 'can_delete')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>webadmin/certificate/delete/<?php echo $certificate->id ?>" class="btn btn-danger btn-xs"  data-toggle="tooltip" title="delete" onclick="return confirm("are you sure you want to delete")">
