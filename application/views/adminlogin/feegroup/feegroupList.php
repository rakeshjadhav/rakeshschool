                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                             <li class="active">Add Fees Group</li>
                        </ol>
                    </div>
                </div>
                              ...
                              <div class="">
                                  <div class="panel " >
                                      <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> 
                                          <i class="fa fa-tags"></i> ||  Add Fees Group
                                     </div>
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12 col-xs-12">
                                          ...
                                          <form action="<?php echo base_url() ?>webadmin/feegroup" method="post">
                                        ...
                                        <input type="submit" name="" id=""class="btn btn-sm btn-success waves-effect waves-light m-r-10" value="Add Fee Group" style="font-style: normal; " data-toggle="modal" data-target=".bs-example-modal-sm" >
