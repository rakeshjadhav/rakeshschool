            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">
                               <i class="fa fa-home fa-fw"></i> || Library List
                        </h4>
                    </div>
                              ...
                              <div class="">
                                  <div class="panel " >
                                      <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> 
                                          <i class="fa fa-tags"></i> ||  Add Librarian
                                     </div>
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12 col-xs-12">
                                          ...
                                          <form action="<?php echo site_url('webadmin/librarian/index') ?>" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                                              ...
                                              <div class="form-group">
                                                  <label for="">Bate of Birth</label>
                                                    <div class="input-group">
                                                       ...
                                                       <input iid="dob" name="dob" placeholder="" type="date" class="form-control"  value="<?php echo set_value('dob'); ?>" /> 
                                                    </div>
                                  ...
                                  <div class="table-responsive">
                                      ...
                                      <table id="example23" class="display nowrap" style="line-height: 1.42857143;font-weight:400;padding:0" >
                                          ...
                                          <tbody>
                                            <?php
                                              $count = 1;
                                              foreach ($librarianlist as $librarianlist) {
                                              ?>
                                              <tr>
                                                  <td> <?php echo $librarianlist['name'] ?></td>
                                                  <td><?php echo $librarianlist['email'] ?></td>
                                                  <td><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($librarianlist['dob'])); ?></td>
                                                  <td><?php echo $librarianlist['phone'] ?></td>
                                                  <td>
                                                      <div class="row ">
                                                          <div class="col-lg-3 ">
                                                              <a href="<?php echo base_url(); ?>webadmin/librarian/view/<?php echo $librarianlist['id'] ?>" class="btn btn-sm btn-primary" title="View" data-toggle="tooltip" ><i class="fa fa-eye"></i></a>
                                                               <a href="<?php echo base_url(); ?>webadmin/teacher/edit/<?php echo $librarianlist['id'] ?>" class="btn btn-sm btn-info" title="edit" data-toggle="tooltip" ><i class="fa fa-pencil-square"></i></a>
                                                           <a href="<?php echo base_url(); ?>webadmin/teacher/delete/<?php echo $librarianlist['id'] ?>" class="btn btn-sm btn-danger" title="delete" data-toggle="tooltip"  onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a>
                                                          </div>
                                                          </div>
                                      </div>	
                                                  </td>
