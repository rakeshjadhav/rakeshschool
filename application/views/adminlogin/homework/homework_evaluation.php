                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12">
                              <div class="">
                                  ...
                                  <form  class="assign_teacher_form" action="<?php echo base_url(); ?>webadmin/homework/evaluation_report/" method="post" enctype="multipart/form-data">
                                  <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12">
                              <div class="">
                                  <div class="panel " >
                                      <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> 
                                          <i class="fa fa-tags"></i> ||   Evaluation Report
...
<!--                                        <th>action</th>
                              ...
                              <?php  ?>
                                ...
                                <?php //}  ?>
                                    <td class="pull-right"><a class="btn btn-info btn-xs" onclick="report(<?php echo $homework['id']; ?>);" title="" data-target="#report" data-toggle="modal"  data-original-title="Evaluation Report"><i class="fa fa-reorder"></i></a></td>
                                </tr>
                       <?php }}?>
                    </tbody>     
                            </table> 
