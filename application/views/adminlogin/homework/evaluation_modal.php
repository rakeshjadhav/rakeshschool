<div class="row row-eq">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 paddlr">
        ...
        <form id="evaluation_data" method="post" class="ptt10" style="min-height: 500px;">
            <?php if (!empty($report)) { ?>
                <div class="alert alert-info">homework_already_evaluated</div>
            <?php } ?>
            <div class="row">
                <?php
                        ...
                        <div class="dualbg text-right">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <div class="btn-group">
                                        <a class="btn btn-default btn-sm selector checkleft" title="select all" style="border-radius: 0;">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row">   
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-4">      
                            <div class="form-group">  
                                <input type="date" id="evaluation_date" name="evaluation_date" class="form-control modalddate97" value="<?php
                                       if (!empty($report)) {
                                           print_r($report[0]['date']);
                                       } else {
                                          echo date('Y-m-d'); 
                                       }
                                       ?>" readonly="">
...
<?php //print_r($enquiry_data);   ?>
            ...
            <h5 class="pt0 task-info-created">
                <!--small class="text-dark">Homework Date <span class="text-dark"><?php echo $result['homework_date'] ?></span> <i class="fa fa-clock-o" data-toggle="tooltip" data-title="Created at 31.05.2018 13:00:09"></i></small-->
            </h5>
            ...
            <div class="task-info task-single-inline-wrap task-info-start-date">
                <h5><i class="fa task-info-icon fa-fw fa-lg fa-calendar-plus-o pull-left fa-margin"></i>
                    <span>homework_date</span>:<?php print_r($result['homework_date']); ?>                                      
                </h5>
            </div>
            <div class="task-info task-single-inline-wrap task-info-start-date">
                <h5><i class="fa task-info-icon fa-fw fa-lg fa-calendar-plus-o pull-left fa-margin"></i>
                    <span>submission_date</span>:<?php print_r($result['submit_date']); ?>                                      
                </h5>
            </div>
            <?php if (!empty($report)) { ?>
                <div class="task-info task-single-inline-wrap task-info-start-date">
                    <h5><i class="fa task-info-icon fa-fw fa-lg fa-calendar-plus-o pull-left fa-margin"></i>
                        <span>evaluation_date</span>:<?php echo $report[0]['date']; ?>                                       
                    </h5>
                </div>
<?php } ?>
            <div class="task-info task-single-inline-wrap ptt10">
                <label><span>created_by</span>: <?php echo $created_by; ?></label>
                <label><span>evaluated_by</span>: <?php echo $evaluated_by; ?></label>            
                <label><span>class</span>: <?php echo $result['class']; ?></label><br/>
                <label><span>section</span>: <?php echo $result['division']; ?></label><br/>
                <label><span>subject</span>: <?php echo $result['name']; ?></label><br/>
                <?php if (!empty($result["document"])) { ?>
                <label>
                    <a href="<?php echo base_url() . "webadmin/homework/download/" . $result["id"] . "/" . $result["document"] ?>">
                        <i class="fa fa-download"></i>
                    </a>
                </label>
                <?php } ?>
                <label><span>description</span>: <br/><?php echo $result['description']; ?></label>
...
<script>
    $(document).ready(function () {
        ...
        $("#evaluation_data").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url("webadmin/homework/add_evaluation") ?>",
                type: "POST",
