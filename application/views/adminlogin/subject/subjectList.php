...
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                              ...
                              <div class="">
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12 col-xs-12">
                                          ...
                                          <form action="<?php echo site_url('webadmin/subject/create') ?>" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                                              <div class="form-group">
                                               ...
                                               <div class="form-group">
                                                <label class="radio-inline">
                                                 <input type="radio" value="Theory" name="type"  <?php if (set_value('type') == "Theory") echo "checked"; ?> checked>Theory
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="type" <?php if (set_value('type') == "Practical") echo "checked"; ?> value="Practical">Practical
                                                </label>
                                               </div>
                                              <div class="form-group">
                                                  <label for="">Subject Code</label>
                                                    <div class="input-group">
                                                       ...
                                                       <input id="phone" name="code" placeholder="" type="text" class="form-control"  value="<?php echo set_value('code'); ?>"  /> 
                                                    </div>
                          ...
                          <?php } ?>
            <div class="col-md-<?php  if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                echo "8";
                       } else {
                echo "12";
              }
            ?>">
                           ...
                           <div class="col-sm-12">
                              <div class="panel">
                                  <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> <i class="fa fa-file fa-fw"></i> || Subject List
                                  </div>
                                 <div class="panel-wrapper collapse in" aria-expanded="true">
                                      <div class="panel-body">
