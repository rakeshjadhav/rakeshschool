...
<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">
                               <i class="fa fa-user fa-fw"></i> || Student Fee Add
                        </h4>
                    </div>
                        ...
                        <div class="row" style="border-bottom: 2px solid #eee">
                            ...
                            <div class="col-md-8 ">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo base_url() ?>webadmin/studentfee" type="button" class="btn btn-primary btn-xs">
                    ...
                    <div class="panel" style="padding-top:0;">
                        ...
                        <div class="row no-print">
                            <div class="col-md-12 mDMb10">
                                <a href="#" class="btn btn-xs btn-info printSelected">
                                    <i class="fa fa-print"></i> Print </a>
                                <span class="pull-right">Date: <?php echo isset($data->date)?date("Y-m-d",strtotime($data->date)):date("Y-m-d",  strtotime("now")); ?></span>
                            </div>
                        </div>   
                        <div class="table-responsive" style="padding-top:15px;">
                           
                            <table class="table table-bordered table-hover example table-fixed-header table-bordered">
                                <thead class="header">
                                    <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group pull-right"> 
                                                        <button type="button" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" 
                                                                ...
                                                                class="btn btn-xs btn-info myCollectFeeBtn <?php echo $display_none; ?>"
                                                                title="Add_fees" data-toggle="modal" data-target="#myFeesModal"
                                                                ><i class="fa fa-plus"></i></button>


                                                        <button  class="btn btn-xs btn-primary printInv" data-fee_master_id="<?php echo $fee_value->id ?>" data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>"  
                                                                 title="Print"
                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group pull-right"> 
                                                                ...
                                                                <?php //if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                    <button class="btn btn-default btn-xs" data-invoiceno="<?php echo $fee_value->student_fees_deposite_id . "/" . $fee_deposits_value->inv_no; ?>" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>" data-toggle="modal" data-target="#confirm-delete" title="revert">
                                                                        <i class="fa fa-undo"> </i>
                                                                    </button>
                                                    <?php // } ?>
                                                                <button  class="btn btn-xs btn-default printDoc" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>"  title="print"><i class="fa fa-print"></i> </button>
                                                            </div>   
                                                        </td>
                                                    </tr>
                                                    <?php
                                            ...
                                            <tr class="dark-light">
                                                ...
                                                <td align="left" class="text text-left">
                                                        ...
                                                        <a href="#" data-toggle="popover" class="detail_popover" >
                                                            ...
                                                            <?php echo 'discount_of'. " " . 'rs' . $discount_value['amount'] . " " . $discount_value['status']. " : " . $discount_value['payment_id']; ?>
                                                        ...
                                                        echo '<p class="text text-danger">' . 'discount_of'. " " . 'rs' . $discount_value['amount'] . " " . $discount_value['status'];
                                                    }
                                                    ?>
                                                ...
                                                <td>
                                                    <div class="btn-group pull-right"> 
                                                        ...
                                                        if ($discount_value['status'] == "applied") {
                                                            ...
                                                            <?php //if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                <button class="btn btn-default btn-xs" data-discounttitle="<?php echo $discount_value['code']; ?>" data-discountid="<?php echo $discount_value['id']; ?>" data-toggle="modal" data-target="#confirm-discountdelete" title="revert">
                                                                    <i class="fa fa-undo"> </i>
                                                                </button>
                <?php
            }
       // }
        ?>
                                                        ...
                                                        <button type="button" data-modal_title="<?php echo 'discount'. " : " . $discount_value['code']; ?>" data-student_fees_discount_id="<?php echo $discount_value['id']; ?>" 
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  id="date" name="admission_date" placeholder="" type="date" class="form-control date"  value="<?php echo isset($data->date)?date("Y-m-d",strtotime($data->date)):date("Y-m-d",  strtotime("now")); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Amount </label><small class="req"> *</small>
                            <div class="col-sm-9">
...
<!--                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Discount Group></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group mb0">
                            <label for="" class="col-sm-3 control-label">Discount<small class="req">*</small></label>
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-2 col-sm-2 ltextright">
                                    ...
                                    <label for="" class="row control-label">Fine<small class="req">*</small></label>
                                </div>
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee" value="Cash" checked="checked">cash
                                </label>
                                <label class="radio-inline">
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="button" class="btn cfees save_button" id="load" >  collect_fees</button>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on('click', '.printDoc', function () {
            ...
            $.ajax({
                url: '<?php echo site_url("webadmin/studentfee/printFeesByName") ?>',
                type: 'post',
        ...
        $(document).on('click', '.printInv', function () {
            ...
            $.ajax({
                url: '<?php echo site_url("webadmin/studentfee/printFeesByGroup") ?>',
                type: 'post',
...
<script type="text/javascript">
    $(document).on('click', '.save_button', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url("webadmin/studentfee/addstudentfee") ?>',
            type: 'post',
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete').on('click', '.btn-ok', function (e) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("webadmin/studentfee/deleteFee") ?>',
                dataType: 'JSON',
        ...
        $('#confirm-discountdelete').on('click', '.btn-discountdel', function (e) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("webadmin/studentfee/deleteStudentDiscount") ?>',
                dataType: 'JSON',
...
<script type="text/javascript">
    $("#myFeesModal").on('shown.bs.modal', function (e) {
       // console.log("sdrere");
        alert("data");
        e.stopPropagation();
        var discount_group_dropdown = '<option value="">Select</option>';
        ...
        $.ajax({
            type: "post",
            url: '<?php echo site_url("webadmin/studentfee/geBalanceFee") ?>',
            dataType: 'JSON',
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length == 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("webadmin/studentfee/printFeesByGroupArray") ?>',
                    type: 'post',
