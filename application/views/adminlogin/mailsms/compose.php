            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">
                               <i class="fa fa-home fa-fw"></i> ||  Send Email / SMS
                        </h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                             <li class="active">Send Email / SMS</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                              ...
                              <div class="">
                                  <div class="panel " >
                                      <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> 
                                          <i class="fa fa-search"></i> || Send Email / SMS
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_group">
                            <form action="<?php echo site_url('webadmin/mailsms/send_group') ?>" method="post" id="group_form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>title</label><small class="req"
                                                                                                               > *</small>
                                                <input autofocus="" class="form-control" name="group_title">
                                            </div>
                                            <div class="form-group">
                                                <label class="pr20">send_through<small class="req"> *</small></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="group_msg_text" name="group_message" class="form-control compose-textarea"><?php echo set_value('message'); ?></textarea>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label for="">message_to</label><small class="req"> *</small>
                                                <div class="well minheight303">
                                                    <div class=" mt0">
                                                        <label><input type="checkbox" name="user[]" value="student"> <b>students</b>
                                                        </label>
                                                    </div>
                                                    <div class="">
                        ...
                        <div class="tab-pane" id="tab_perticular">
                            <form action="<?php echo site_url('webadmin/mailsms/send_individual') ?>" method="post" id="individual_form">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label for="inpuFname">message_to</label><small class="req"> *</small>
                        ...
                        <div class="tab-pane" id="tab_class">
                            <form action="<?php echo site_url('webadmin/mailsms/send_class') ?>" method="post" id="class_form">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#search-query").keyup(function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('webadmin/mailsms/search') ?>",
