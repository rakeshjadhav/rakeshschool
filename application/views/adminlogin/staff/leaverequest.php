            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">
                               <i class="fa fa-home fa-fw"></i> || Leaves
                        </h4>
                    </div>
                     ...
                     <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;">
                                <i class="fa fa-tags fa-fw"></i> || Leaves
                                <?php //if ($this->rbac->hasPrivilege('apply_leave', 'can_add')) { ?>
                                  <small class="pull-right">
                                      <a href="#" data-toggle="modal" data-target="#addleave" role="button" class="btn btn-primary btn-sm checkbox-toggle pull-right edit_setting">Apply_leave</a></small>
                               <?php // } ?>
                            </div>
                                            ...
                                            foreach ($leave_request as $key => $value) {
                                                ...
                                                <tr>   
                                                    ...
                                                    <td><span data-toggle="popover" class="detail_popover" data-original-title="" title="">
                                                            <small <?php echo $label ?>><?php echo $status[$value["status"]]; ?></small>
                                                        </span>

                                                        <div class="fee_detail_popover" style="display: none">
                                                            <?php echo "Submitted By: " . $value['applied_by']; ?></div></td>
                                                    <td class="pull-right no-print">
                                                        <a href="#leavedetails" onclick="getRecord('<?php echo $value["id"] ?>')" role="button" class="btn btn-primary btn-xs" data-toggle="tooltip" title="view" >
                        ...
                        <div class="col-md-12 table-responsive">  
                            <table class="table mb0 table-striped table-bordered ">
                                <tr>
                                    ...
                                    <th width="15%">staff_id</th>
                                    <td width="35%"><span id="employee_id"></span>
                                        <span class="text-danger">leave_request_id</span>
                                    </td>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6 ">
                            <label> leave type</label><small class="req"> *</small>
                            <div id="leavetypeddl">
                        ...
                        <div class="form-group col-xs-6 col-sm-12 col-md-12 col-lg-6">
                            <label>leave Strat date</label>
...
//        $('#reservation').daterangepicker();
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.document_file != "") {
                    ...
                    $("#download_file").html('<a href=' + base_url + 'webadmin/staff/download/' + result.staff_id + '/' + result.document_file + ' class=btn btn-default btn-xs  data-toggle=tooltip >' + cl + '</a>');
                }
    ...
    $(document).ready(function (e) {
        $("#addleave_form").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url("webadmin/leaverequest/add_staff_leave") ?>",
                type: "POST",
