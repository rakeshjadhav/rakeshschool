...
<head>
   ...
   <link href="<?php echo base_url() ?>assets/backend/plugins/bower_components/calendar/dist/fullcalendar.css" rel="stylesheet" />
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-left">
                        ...
                        <ul class="dropdown-menu mailbox animated bounceInDown">
                            ...
                            <li>
                                <div class="message-center">
                                    <a href="#">
                                        <div class="user-img"> 
                                            <!--<img src="<?php //echo base_url(); ?>assets/backend/plugins/images/users/pawandeep.jpg" alt="user" class="img-circle">-->
                                            <span class="profile-status online pull-right"></span>
                                        </div>
                                        <div class="mail-contnet">
                                            <h5>Rakesh Jadhav</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                    </a>
                                </div>
                            </li>
                            <li>
                    ...
                    <li class="dropdown">
                         <a href="" data-toggle="modal" data-target="#sessionModal">
                             <?php echo ('Current Year') . ": " . $this->setting_model->getCurrentSessionName(); ?>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> 
                            ...
                            <b class="hidden-xs">  <?php echo $this->customlib->getAdminSessionUserName(); ?> </b><span class="caret"></span> </a>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>webadmin/admin/dashboard" class="waves-effect">
                           <i class="mdi mdi-apps fa-fw"></i> 
                            <span class="hide-menu"> Dashboard </span>
                        </a>
                    </li>
                    <li> <a href="javascript:void(0)" class="waves-effect">
                                    <i data-icon="&#xe008;" class="ti-dashboard fa-fw fa-fw"></i>
                                    <span class="hide-menu"> School Management</span>
                                    <span class="fa arrow"></span>
                                </a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/enquiry">
                                            <i class="fa fa-search fa-fw "></i>
                                            <span class="hide-menu">Admission Enquiry</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/visitorspurpose">
                                            <i class="fa fa-cog fa-fw "></i>
                                            <span class="hide-menu">Setup</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/complaint">
                                            <i class="fa fa-file fa-fw "></i>
                                            <span class="hide-menu"> Complaint</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/visitors">
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect">
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/student/search">
                                            <i class="fa fa-search fa-fw "></i>
                                            <span class="hide-menu">Student Details</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/student/create">
                                            <i class="fa fa-user fa-fw "></i>
                                            <span class="hide-menu">Admission</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/student/studentreport">
                                            <i class="fa fa-user fa-fw "></i>
                                            <span class="hide-menu">Student Report</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/student/guardianreport">
                                            <i class="fa fa-user fa-fw "></i>
                                            <span class="hide-menu">Guardian Report</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/users/admissionreport">
                                            <i class="fa fa-user fa-fw "></i>
                                            <span class="hide-menu">Student History</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/users/logindetailreport">
                                            <i class="fa fa-user fa-fw "></i>
                                            <span class="hide-menu">Login detail</span>
                                       </a>
                                   </li>
                                   ...
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/student/disablestudentslist">
                                            <i class="fa fa-user-plus fa-fw "></i>
                                            <span class="hide-menu"> disable students</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/stdtransfer/index">
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/studentfee">
                                            <i class="fa fa-rupee fa-fw "></i>
                                            <span class="hide-menu"> || Collect Fee</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/studentfee/searchpayment">
                                            <i class="fa fa-rupee fa-fw "></i>
                                            <span class="hide-menu"> || Search payment</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/studentfee/feesearch">
                                            <i class="fa fa-rupee fa-fw "></i>
                                            <span class="hide-menu"> || Due Fees</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/studentfee/reportbyname">
                                            <i class="fa fa-rupee fa-fw "></i>
                                            <span class="hide-menu"> || Fee Statement</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/transaction/studentacademicreport">
                                            <i class="fa fa-rupee fa-fw "></i>
                                            <span class="hide-menu"> || Balance Fee Report</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/feetype">
                                            <i class="fa fa-tags fa-fw "></i>
                                            <span class="hide-menu"> || Fee Type</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/feegroup">
                                            <i class="fa fa-tags fa-fw "></i>
                                            <span class="hide-menu"> || Fee Group</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/feemaster">
                                            <i class="fa fa-tags fa-fw "></i>
                                            <span class="hide-menu"> || Fee Master</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/feediscount">
                                            <i class="fa fa-tags fa-fw "></i>
                                            <span class="hide-menu"> || Fee Discount</span>
                                       </a>
                                   </li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/stuattendence">
                                ...
                                <?php 
                                // if (//$this->module->hasActive('academics')) {
                                 if (($this->rbac->hasPrivilege('division', 'can_view') ||
                                      $this->rbac->hasPrivilege('class', 'can_view')  ||
                                       $this->rbac->hasPrivilege('subject', 'can_view') ||
                                        $this->rbac->hasPrivilege('assign_teacher', 'can_view') ))
                                     // $this->rbac->hasPrivilege('teacher', 'can_view') ||
                             ...
                             <li> 
                                ...
                                <ul class="nav nav-third-level">
                                    <?php if ($this->rbac->hasPrivilege('division', 'can_view')) {?>
                                    <li><a href="<?php echo base_url(); ?>webadmin/sections">
                                    <i class="fa fa-retweet fa-fw "></i>
                                    <span class="hide-menu">Divisions</span>
                                       </a>
                                   </li>
                                    <?php }  if ($this->rbac->hasPrivilege('class', 'can_view')) {?>
                                   <li><a href="<?php echo base_url()?>webadmin/classes">
                                    <i class="fa fa-university fa-fw "></i>
                                    <span class="hide-menu">Classes</span>
                                       </a>
                                   </li>
                                    <?php }  if ($this->rbac->hasPrivilege('subject', 'can_view')) {?>
                                    <li><a href="<?php echo base_url()?>webadmin/subject">
                                         <i class="fa fa-file fa-fw "></i>
                                         <span class="hide-menu">Subjects</span>
                                       </a>
                                    </li>                                   
                                   <?php }  if ($this->rbac->hasPrivilege('class', 'can_view')) {?>                                
                                   <li><a href="<?php echo base_url()?>webadmin/teacher/assign_class_teacher">
                                    <i class="fa fa-user-plus fa-fw "></i>
                                    <span class="hide-menu">Class Teacher</span>
                                       </a>
                                   </li>                                                                      
                                   <?php } if ($this->rbac->hasPrivilege('assign_teacher', 'can_view')) {?>                                
                                   <li><a href="<?php echo base_url()?>webadmin/teacher/assignteacher">
                                    <i class="fa fa-tags fa-fw "></i>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/grade">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Marks Grade</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/exam">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Exam</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/exam/subjectwisechapter">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Chapter</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/examschedule">
                                    <i class="ti  ti-share fa-fw "></i>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/homework">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Add Homework</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/homework/evaluation_report">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Evaluation Report</span>
                                       </a>
                                   </li>
                                 ...
                                 <li> <a href="javascript:void(0)" class="waves-effect">
                                    <i data-icon="&#xe008;" class="linea-icon linea-basic fa-fw"></i>
                                    <span class="hide-menu"> Communicate </span>
                                    <span class="fa arrow"></span>
                                </a>
                                <ul class="nav nav-third-level">
                                    <li>
                                   ...
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/notification/add">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Send Message</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/mailsms/compose">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Send Email/SMS</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/mailsms/index">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Email / SMS Log</span>
                                       </a>
                                   </li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || book Add</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/book/getall">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Book List</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/member">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Book Return</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/member/student">
                                    <i class="ti  ti-share fa-fw "></i>
                                    <span class="hide-menu"> || Add Student</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/member/teacher">
                                    <i class="ti  ti-share fa-fw "></i>
...
<!--                                   <li >
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/designation/designation">
                                    <i class='ti ti-direction-alt fa-fw'></i>
                                    <span class="hide-menu">  Designation</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/department/department">
                                    <i class='ti ti-layout fa-fw'></i>
                                    <span class="hide-menu"> Department</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/leavetypes">
                                    <i data-icon="F" class="linea-icon linea-software"></i>
                                    <span class="hide-menu"> || Leave Types</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/staff">
                                    <i data-icon="F" class="linea-icon linea-software"></i>
                                    <span class="hide-menu"> || Staff</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/staff/leaverequest">
                                    <i data-icon="F" class="linea-icon linea-software"></i>
                                    <span class="hide-menu"> || leave request</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/leaverequest/leaverequest">
                                    <i data-icon="F" class="linea-icon linea-software"></i>
                                    <span class="hide-menu"> || leave request</span>
                                       </a>
                                   </li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/certificate">
                                    <i data-icon="F" class="linea-icon linea-software"></i>
                                    <span class="hide-menu"> || certificate</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/generatecertificate">
                                    <i data-icon="F" class="linea-icon linea-software"></i>
                                 ...
                                 <li> <a href="javascript:void(0)" class="waves-effect">
                                    <i data-icon="/" class="linea-icon linea-basic fa-fw"></i>
                                    <span class="hide-menu"> Master Setting </span>
                                    <span class="fa arrow"></span>
                                </a>
                                <ul class="nav nav-third-level">
                                    <li>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/sessions">
                                    <i class="fa fa-database fa-fw"></i>
                                    <span class="hide-menu"> Academic Years</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/roles">
                                    <i class="fa fa-lock fa-fw"></i>
                                    <span class="hide-menu"> Role/Permission</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/admin/backup">
                                    <i class="fa fa-database fa-fw"></i>
                                    <span class="hide-menu"> Backup</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>webadmin/users">
                                    <i class="fa fa-users fa-fw"></i>
                                    <span class="hide-menu"> Users</span>
                                       </a>
                                   </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>webadmin/module">
                                    <i data-icon="Y" class="linea-icon linea-basic fa-fw"></i>
                                 ...
                                 <li>
                                     <a href="javascript:void(0)" class="waves-effect"></a>
