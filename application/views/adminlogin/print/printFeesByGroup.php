                    ...
                    <div class="invoice">
                        <div class="row header text-center">
                            ...
                            <div class="col-sm-8">
                                ...
                                Phone: <?php echo $settinglist[0]['phone']; ?><br>
                        ...
                        <div class="row">                           
                            <div class="col-xs-6">
                                ...
                                <address>
                                    ...
                                    Father Name: <?php echo $feeList->father_name; ?><br>
                                    Class : <?php echo $feeList->class . " (" . $feeList->division . ")"; ?>
                                </address>
                            </div>
                        ...
                        <div class="row">
                            ...
                            if (!empty($feeList)) {
                                ...
                                <table class="table table-striped table-responsive" style="font-size: 8pt;">
                                    ...
                                    <th>Fees_group</th>
                                    <th>Fees_code</th>
                                    <th  class="">Due_date</th>
                                    <th class="">Status</th>
                                    <th  class="text text-right">Amount</th>
                                    <th  class="text text-center">Payment_id</th>
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($feeList)) {
                                            ...
                                            <tr  class="dark-gray">
                                                ...
                                                <td class="text text-right"><?php echo  $feeList->amount; ?></td>
