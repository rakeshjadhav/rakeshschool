                              ...
                              <div class="">
                                  <div class="panel " >
                                      <div class="panel-heading" style="text-transform: uppercase;border-bottom: 1px solid #eee;"> 
                                          <i class="fa fa-tags"></i> ||  Add Fees Master <?php echo $this->setting_model->getCurrentSessionName(); ?>
                                     </div>
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12 col-xs-12">
                                          ...
                                          <form action="<?php echo base_url() ?>webadmin/feemaster" method="post">
                                              ...
                                              <div class="form-group">
                                                  <label for="">Due Date</label>
                                                    <div class="input-group">
                                                       <div class="input-group-addon"><i class="fa fa-tags"></i></div>
                                                       <input id="due_date" name="due_date" placeholder="" type="date" class="form-control"  value="<?php echo set_value('due_date'); ?>" />
                                                    </div>
                                        ...
                                        <input type="submit" name="" id=""class="btn btn-sm btn-success waves-effect waves-light m-r-10" value="Save" style="font-style: normal; ">
                                    ...
                                    foreach ($feemasterList as $feegroup) {
                                        ...
                                        <tr>
                                            ...
                                            <?php //if ($this->rbac->hasPrivilege('fees_master', 'can_delete')) { ?>
                                                    <a href="<?php echo base_url(); ?>webadmin/feemaster/deletegrp/<?php echo $feegroup->id ?>" class="btn btn-danger btn-xs"  data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure you want to delete this item?');">
                                                        <i class="fa fa-remove"></i>
                                                    </a>
                                           <?php //} ?>
                                            </td>
