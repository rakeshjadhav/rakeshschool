                ...
                <div class="col-md-4">
                    ...
                    <div class="panel box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> <i class="fa fa-users fa-fw"></i> || Add visitor</h3>
                        </div><!-- /.box-header -->
                        <?php //echo $this->session->flashdata('msg')  ?>
                        <form id="form1" action="<?php echo site_url('webadmin/visitors') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="pwd">date</label><input type="date" id="date" class="form-control" value="<?php echo set_value('date') ?>"  name="date" >
