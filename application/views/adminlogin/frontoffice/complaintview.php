            ...
            <div class="container-fluid">
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">
                               <i class="fa fa-home fa-fw"></i> || complaint view
                        </h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Dashboard</a></li>
                             <li class="active">Add complaint view</li>
                        </ol>
                    </div>
                </div>
            ...
            <?php if ($this->rbac->hasPrivilege('complaint', 'can_add')) { ?>
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('webadmin/complaint') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                        ...
                                        foreach ($complaint_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right" >
                                                    <a onclick="getRecord(<?php echo $value['id']; ?>)" class="btn btn-primary btn-xs" data-target="#complaintdetails" title="view" data-toggle="modal" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing" data-original-title="View"><i class="fa fa-reorder"></i></a>
                                                    <?php if ($value['image'] !== "") { ?><a href="<?php echo base_url(); ?>webadmin/complaint/download/<?php echo $value['image']; ?>" class="btn btn-success btn-xs" data-toggle="tooltip" title="" data-original-title="Download">
                                                            <i class="fa fa-download"></i>
                                                        </a>  <?php } ?> 
                                                    <?php if ($this->rbac->hasPrivilege('complaint', 'can_edit')) { ?>    
                                                        <a href="<?php echo base_url(); ?>webadmin/complaint/edit/<?php echo $value['id']; ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="Edit">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('complaint', 'can_delete')) { ?>
                                                        <?php if ($value['image'] !== "") { ?><a href="<?php echo base_url(); ?>webadmin/complaint/imagedelete/<?php echo $value['id']; ?>/<?php echo $value['image']; ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" title="" onclick="return confirm('Are you sure ??');" data-original-title="Delete">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php } else { ?>
                                                            <a href="<?php echo base_url(); ?>webadmin/complaint/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('Are you sure want to delete this intm ???');" data-original-title="Delete">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php }
                                                    }
...
//        });
    ...
    function getRecord(id) {
        //alert(id);
        $.ajax({
            url: '<?php echo base_url(); ?>webadmin/complaint/details/' + id,
