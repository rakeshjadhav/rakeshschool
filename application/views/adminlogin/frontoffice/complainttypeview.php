                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">add complain type</h3>
                        </div><!-- /.box-header -->

                        <form id="form1" action="<?php echo site_url('webadmin/complainttype') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">                        
