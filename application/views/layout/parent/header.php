                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            ...
                            <li><a href="<?php echo base_url(); ?>parent/parents/changepass"><i class="ti-email"></i> Change Password</a></li>
                     ...
                     <li class="user-pro">
                        <a href="#" class="waves-effect">
                            ...
                            <span class="hide-menu">
                                <?php echo character_limiter($this->customlib->getStudentSessionUserName(),8) ?>
...
<!--                        <ul class="nav nav-second-level">
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect">
                                ...
                                foreach ($ch as $key_ch => $value_ch) {
                                    ?>
                                    <li>
                                        <a href="<?php echo base_url(); ?>parent/parents/getstudent/<?php echo $value_ch['student_id'] ?>">
                                            <i class="fa fa-tags fa-fw "></i>
                                            <span class="hide-menu"> || <?php echo $value_ch['name'] ?></span>
                                       </a>
                                   </li>
                                   <?php
                                }
                                ...
                                foreach ($ch as $key_ch => $value_ch) {
                                    ?>
                                    <li>
                                        <a href="<?php echo base_url(); ?>parent/parents/getexams/<?php echo $value_ch['student_id'] ?>">
                                            <i class="fa fa-tags fa-fw "></i>
                                            <span class="hide-menu"> || <?php echo $value_ch['name'] ?></span>
                                       </a>
                                   </li>
                                ...
                                <li>
                        <a href="<?php echo base_url(); ?>parent/notification" class="waves-effect">
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect">
                                ...
                                <li>
                        <a href="<?php echo base_url(); ?>parent/teacher" class="waves-effect">
                           <i class="mdi mdi-apps fa-fw"></i> 
                            <span class="hide-menu"> teachers </span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>parent/book" class="waves-effect">
                           <i class="mdi mdi-apps fa-fw"></i> 
                            <span class="hide-menu"> Library </span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>parent/route" class="waves-effect">
                           <i class="mdi mdi-apps fa-fw"></i> 
                            <span class="hide-menu"> Transport </span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>parent/hostel" class="waves-effect">
                           <i class="mdi mdi-apps fa-fw"></i> 
