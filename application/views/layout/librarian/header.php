                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            ...
                            <li><a href="<?php echo base_url(); ?>librarian/librarian/changepass"><i class="ti-email"></i> Change Password</a></li>
                ...
                <ul class="nav" id="side-menu">
                     <li class="user-pro">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url()?>webadmin/profile ">
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>librarian/librarian/dashboard" class="waves-effect">
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect">
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>librarian/book/getall">
                                            <i class="fa fa-tags fa-fw "></i>
                             ...
                             <li> <a href="javascript:void(0)" class="waves-effect">
                                    ...
                                    <span class="hide-menu"> Issue Return </span>
                                    <span class="fa arrow"></span>
                                </a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="<?php echo base_url(); ?>librarian/teacher">
                                    <i class="fa fa-tags fa-fw "></i>
                                    <span class="hide-menu"> || Add Teacher</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url(); ?>librarian/member">
                                    <i class="fa fa-tags fa-fw "></i>
                                    <span class="hide-menu"> || Books issue return</span>
                                       </a>
                                   </li>
                                   <li>
                                        <a href="<?php echo base_url()?>librarian/student/search">
                                    <i class="fa fa-tags fa-fw "></i>
