                                ...
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)">
                                            <img src="<?php echo base_url() . $student['image'] ?>" class="thumb-lg img-circle" alt="profile imgae">
                                        </a>
                                                        ...
                                                        <td align="left" class="text text-left">
                                                            ...
                                                            if ($discount_value['status'] == "applied") {
                                                                ...
                                                                <a href="#" data-toggle="popover" class="detail_popover" >
                                                                    ...
                                                                    <?php echo "Discount Of". " " . Rs . $discount_value['amount'] . " " . ($discount_value['status']) . " : " . $discount_value['payment_id']; ?>
                                            ...
                                            <div class="table-responsive borgray around10">  
                                                ...
                                                <table class="table table-striped table-bordered table-hover example">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <tr class="hide">
                                                            <td>Exam <?php echo $value['exam_name']; ?></td>
                                                            <td>
                                                                <?php
                                                                if ($result == "Pass") {
                                                                    ?>
                                                                    <b class='text text-success'><?php echo ('Result') .": ". $result; ?></b>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <b class='text text-danger'><?php echo ('Result') .": ". $result; ?></b>
                                                                    <?php
                                                                }
                                                                ?></td>
                                                            <td><?php
                                                                echo ('Grand_total') . ": " . $obtain_marks . "/" . $total_marks;
                                                                ;
                                                                ?></td>
                                                            <td><?php
                                                                $foo = ($obtain_marks * 100) / $total_marks;
                                                                echo ('Percentage') .": ". number_format((float) $foo, 2, '.', '');
                                                                ?></td>
                                                            <td><?php
                                                                if (!empty($gradeList)) {
                                                    ...
                                                    foreach ($student_doc as $value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mailbox-date pull-right">
                                                                ...
                                                                <a href="<?php echo base_url(); ?>webadmin/student/doc_delete/<?php echo $value['id'] . "/" . $value['student_id']; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="delete" onclick="return confirm('Are you sure you want to delete this item?');">
