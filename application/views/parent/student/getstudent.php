            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Student Information </h4> </div>
                                                        ...
                                                        <table class="table table-striped " >
                                                         <tr>
                                                             <td style="width:30%;" >Admission Date</td>
                                                              <td> <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['admission_date'])); ?></td>
                                                         </tr>
                                                         <tr>
                                                             <td>Date Of Birth</td>
                                    ...
                                    <table id="example" class="table table-hover table-striped">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text text-right">Amount<span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                ...
                                                <th class="text text-right">Fine <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text text-right">Paid <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                        ...
                                                        <td align="left" class="text text-left">
                                                            ...
                                                            if ($discount_value['status'] == "applied") {
                                                                ...
                                                                <a href="#" data-toggle="popover" class="detail_popover" >
                                                                    ...
                                                                    <?php echo "Discount Of". " " . $currency_symbol . $discount_value['amount'] . " " . $this->lang->line($discount_value['status']) . " : " . $discount_value['payment_id']; ?>
                                                    ...
                                                    foreach ($student_doc as $value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="mailbox-date pull-right">
                                                                <a href="<?php echo base_url(); ?>webadmin/student/download/<?php echo $value['student_id'] . "/" . $value['doc']; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="Download">
                                                                    <i class="fa fa-download"></i>
                                                                </a>
                                                                <a href="<?php echo base_url(); ?>webadmin/student/doc_delete/<?php echo $value['id'] . "/" . $value['student_id']; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
